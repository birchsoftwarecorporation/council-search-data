...
<div class="preview" style="display: none; max-height: 0px; overflow: hidden;">
    Council Search - We found <%= messageMap.get("eventsCount") %> new event(s) - <%= messageMap.get("dateToday") %>
</div>
                            ...
                            <tr>
                                <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                            ...
                                            <table class="mx-auto" align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0 auto;">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-12 " align="left" valign="top" style="line-height: 24px; font-size: 16px; min-height: 1px; padding-right: 15px; padding-left: 15px; font-weight: normal; width: 100%; margin: 0;">
                                                        ...
                                                        <a class="" href="<%= baseUrl %>/home">
                                                            <img width="300" height="115" alt="Council Search" src="https://www.councilsearch.com/assets/images/logo/logoRegGreyVertical.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
                                                        </a>
                                    ...
                                    <table class="row" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin-right: -15px; margin-left: -15px; table-layout: fixed; width: 100%;">
                                        ...
                                        <tr>
                                            <th class="col-12" align="left" valign="top" style="line-height: 24px; font-size: 16px; min-height: 1px; padding-right: 15px; padding-left: 15px; font-weight: normal; width: 100%; margin: 0;">
                                                <h6 class="text-muted text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 16px; line-height: 19.2px; color: #636c72;" align="center"><%= messageMap.get("eventsCount") %> Recently Added Event(s) - <%= messageMap.get("dateToday") %></h6>
                                            </th>
                                        </tr>
                                        </thead>
                                    </table>
                                    <!-- END HEADER -->
                                    <!-- Start Alerts -->
                                    <g:each in="${messageMap.get("alerts")}" var="alertMap">
                                        <g:render template="/emails/notifications/alertContent" model="[baseUrl: baseUrl, alertMap: alertMap]" />
                                    </g:each>
                                    <!-- End Start Alerts -->
